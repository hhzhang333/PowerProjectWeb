...
<div class="admin-container clearfix">
    ...
    <div class="admin-container-content fl">
        <div class="mt-20" style="overflow:auto;height: 900px;">
            <div class="admin-container-content-bread f20">能源监控</div>
            <div class="admin-container-content-main" style="width: 100%;height: 100%;">
                <iframe src="/powerMonitor" frameborder="0" id="sub-frame" style="height:100%;width:100%"></iframe>
            </div>
        </div>
    </div>
</div>
